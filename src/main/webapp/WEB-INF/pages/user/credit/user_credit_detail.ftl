...
<div class="page-content extended">
    <div class="tabbable-custom">
        <ul class="nav nav-tabs" style="width:80%">
            <li class="active"><a href="#tab_1" data-toggle="tab">用户额度信息</a></li>
...
<script>
    ...
    <#if !id??>
        ...
        $('#backbtn').click(function () {
            window.location.href = "${user_credit_list_url}";
        });
    ...
    function refresh() {
        <#--$('#tab_1_iframe').attr('src', "${BASEPATH}/user/loan/detail/apply?id=${id!}");-->
        $('#tab_1_iframe').attr('src', "${BASEPATH}/user/credit/detail/base?id=${id!}");
    }
