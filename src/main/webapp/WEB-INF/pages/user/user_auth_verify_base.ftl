                    ...
                    <form id="base-info-form" name="base-info-form" class="base-info-form form-horizontal">
                        ...
                        <table cellpadding="5px" width="400px">
                            ...
                            <tr class="form-group">
                                ...
                                <td class="input-group"><input id = "mobile" name="mobile" value="${user.mobile}" size="11" minlength="11" maxlength="11"
                            ...
                            <tr class="form-group">
                                ...
                                <td class="input-group"><input id = "QQ" name="QQ" onkeyup="(this.v=function(){this.value=this.value.replace(/[^0-9-]+/,'');}).call(this)" onblur="this.v();" value="${user.QQ}" value="${user.QQ}" minlength="4" maxlength="11" validate="{required:false}"
