...
<div class="page-content extended">
    <div class="tabbable-custom">
        <ul class="nav nav-tabs" style="width:80%">
            <li class="active"><a href="#tab_1" data-toggle="tab">贷后信息</a></li>
...
<script>
    ...
    <#if !id??>
        ...
        $('#backbtn').click(function () {
            window.location.href = "${user_repayment_list_url}";
        });
    ...
    function refresh() {
        $('#tab_1_iframe').attr('src', "${BASEPATH}/user/repayment/detail/base?id=${id!}");
    };
