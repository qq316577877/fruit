 ...
 */
@Service
public class TailPayOrderProcessor extends DefaultOrderProcessor {


    public TailPayOrderProcessor() {
    ...
    protected void  handleExtraAfter(OrderProcessRequest request, OrderStatusEnum nextStatus){
        ...
        //短信发送
        final String content =  newOrderStateMachine.getSmsTemplate(request.getStatusBefore(),OrderEventEnum.SETTLEMENT)
        ...
        if(StringUtils.isNotBlank(openid)) {
            ...
            dataListP.add(new TemplateParamVO("first", "尊敬的客户，您的订单费用已结清.", "#000000"));
